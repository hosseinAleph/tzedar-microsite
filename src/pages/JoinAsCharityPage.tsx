...
function DgrCallout() {
  return (
    <div className="flex gap-3 items-start p-4 rounded-xl border border-[#4a82c4] bg-[#edf3fb]">
      <Info className="w-5 h-5 text-[#3b6fa8] shrink-0 mt-0.5" />
      <div className="flex flex-col gap-0.5">
        <p className="text-sm font-semibold text-[#2d5788]">DGR status is required</p>
        <p className="text-xs text-[#3b6fa8] leading-snug">
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      ...
      <input
        ...
        className="h-11 w-full px-4 rounded-lg border border-[#8fa898] bg-white text-sm text-text-primary placeholder:text-[#8fa898] focus:outline-none focus:ring-2 focus:ring-brand transition"
      />
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-3">
        <button
          type="submit"
          className="w-full flex items-center justify-center gap-2 py-3.5 rounded-full font-semibold text-sm text-white transition hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
          style={{ backgroundImage: "linear-gradient(178deg, #5ba88a 5%, #3d8c6e 87%)" }}
        >
          Join as a partner
...
export function JoinAsCharityPage() {
  return (
    <div className="min-h-screen bg-white lg:bg-[#f7f7f7] flex flex-col">
      ...
      <div className="hidden lg:flex flex-1 min-h-screen">
        ...
        {/* Left sidebar — green */}
        <div
          className="relative flex flex-col justify-between w-[360px] xl:w-[420px] shrink-0 px-8 pt-10 pb-12 rounded-[24px] m-4 overflow-hidden"
          style={{ background: "#589c82" }}
        >
          {/* Decorative glow */}
          <img
            src={decorImage}
          ...
          <div className="relative z-10 flex flex-col gap-6 mt-8">
            ...
            <h1 className="font-bold text-4xl xl:text-5xl text-white leading-none">
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-[580px] bg-white rounded-[32px] shadow-[0px_2px_7.5px_rgba(25,33,61,0.1)] border border-[#f1f2f9] px-12 py-10">
            <PartnerForm />
          </div>
        </div>
      </div>
      ...
      <div className="lg:hidden flex flex-col flex-1">
        {/* Mobile nav */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-[#d4ddd4] sticky top-0 bg-white z-10">
          <Logo height={28} />
        ...
        {/* Green hero card */}
        <div
          className="relative mx-4 mt-4 rounded-2xl px-6 py-10 overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-4">
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-white/80">Charity partnership</p>
            <h1 className="font-semibold text-2xl text-white leading-snug">
              Raise funds better, faster, and for free.
            </h1>
